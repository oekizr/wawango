...
function submit() {
    form.post(route('provider.menus.store'));
}
</script>
...
<template>
    ...
    <ProviderLayout>
        <template #header>
            <h1 class="text-xl font-semibold text-gray-800 dark:text-gray-100">Tambah Menu</h1>
        </template>
        ...
        >
            <div>
                ...
                <InputError class="mt-1" :message="form.errors.store_id" />
            </div>
            ...
            <ImageUploadField v-model="form.foto" label="Foto Menu" :error="form.errors.foto" />
