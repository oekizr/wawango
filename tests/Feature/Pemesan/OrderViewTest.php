...
class OrderViewTest extends TestCase
{
    ...
    public function test_pemesan_can_view_own_order_detail(): void
    {
        ...
        OrderItem::factory()->create(['order_id' => $order->id, 'nama_menu_snapshot' => 'Ayam Goreng', 'qty' => 2]);
        ...
        $this->actingAs($user)->get(route('pemesan.orders.show', $order))
            ...
            ->assertInertia(fn ($page) => $page
                ...
                // items must resolve to a plain array, not a nested
                // {"data": [...]} resource-collection envelope.
                ->where('order.items.0.nama_menu', 'Ayam Goreng')
